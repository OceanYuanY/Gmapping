...
class SlamGMapping
{
  public:
    ...
    void laserCallback(const laserscan_pro::LaserScanPro::ConstPtr& scanpro);
  ...
  private:
    ...
    message_filters::Subscriber<laserscan_pro::LaserScanPro>* scan_filter_sub_;
    tf::MessageFilter<laserscan_pro::LaserScanPro>* scan_filter_;
